...
function playRound ( playerChoiceLowerCase){
    ...
    let playerChoice = playerChoiceLowerCase.charAt(0).toUpperCase() + playerChoiceLowerCase.substring(1);
...
function game(){
    window.addEventListener('click', function(e) {
        ...
        const buttonSelected = document.querySelector(`.weapon[data-key="${e.path [1].id}"]`);
